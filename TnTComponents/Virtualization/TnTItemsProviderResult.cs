...
public readonly struct TnTItemsProviderResult<TItem>() {
    ...
    ///     means the total number of items in the underlying data source after applying any
    ///     filtering that is in effect. /// If the grid is paginated, this should include all
    ///     pages. If the grid is virtualized, this should include the entire scroll range.
    /// </summary>
