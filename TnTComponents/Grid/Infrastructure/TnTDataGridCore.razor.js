...
class TnTTable extends HTMLTableElement {
    ...
    disconnectedCallback() {
        let identifier = self.getAttribute(TnTComponents.customAttribute);
    ...
    attributeChangedCallback(name, oldValue, newValue) {
        if (name === TnTComponents.customAttribute && oldValue != newValue) {
            ...
            tableElementsMapByIdentifier.set(newValue, self);
        }
    }
