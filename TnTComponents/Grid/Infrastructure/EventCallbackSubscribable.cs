...
/// </summary>
/// <typeparam name="T">A type for the event args.</typeparam>
internal sealed class EventCallbackSubscribable<T> {
    ...
    public void Subscribe(EventCallbackSubscriber<T> owner, EventCallback<T> callback) => _callbacks.Add(owner, callback);
