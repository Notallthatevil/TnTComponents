...
// [Parameter] public string CellContentContainerClass { get; set; } = "tnt-data-cell-content-container";

// [Parameter] public RenderFragment ChildContent { get; set; } = default!;

// [Parameter] public override string? Class { get; set; } = "tnt-data-grid";

// [Parameter] public string ContainerClass { get; set; } = "tnt-data-grid-container";

// [Parameter] public Expression<Func<TGridItem, object>>? DefaultSort { get; set; }
...
// [Parameter] public TnTItemsProvider<TGridItem>? ItemsProvider { get; set; }

// [Parameter] public double? MaxHeight { get; set; }

// [Parameter] public string Name { get; set; } = default!;

// [Parameter] public EventCallback<DataGridRowClickEventArgs> RowClickedCallback { get; set; }
...
// public TnTDataGrid() { _context = new(this); }

// public void Refresh() { StateHasChanged(); }

// protected override void OnParametersSet() { base.OnParametersSet(); if
// (string.IsNullOrWhiteSpace(Name)) { throw new InvalidOperationException($"{nameof(Name)} must be
// provided!"); }
