...
if (!global.NTComponents) {
  global.NTComponents = { customAttribute: 'tnt-id' };
}
...
describe('TnTRippleEffect web component', () => {
  ...
  test('attributeChangedCallback tracks identifiers and triggers update', () => {
    ...
    el.setAttribute(NTComponents.customAttribute, 'id1');
    el.setAttribute(NTComponents.customAttribute, 'id2');
  ...
  test('disconnectedCallback removes identifier mapping', () => {
    ...
    parent.appendChild(el);
    document.body.appendChild(parent);
    el.setAttribute(NTComponents.customAttribute, 'abc');
