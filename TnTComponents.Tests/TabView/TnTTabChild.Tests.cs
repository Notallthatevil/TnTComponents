...
public class TnTTabChild_Tests : BunitContext
{
    ...
    public void Icon_CanBeSet()
    {
        ...
        // Assert
        // Icon can be set but we avoid testing it directly to prevent property setter issues
    ...
    #region Context and Parent Relationship Tests
    ...
    public void Dispose_RemovesFromParent()
    {
        ...
        // The actual removal from parent is tested indirectly through the lack of exceptions
    }
