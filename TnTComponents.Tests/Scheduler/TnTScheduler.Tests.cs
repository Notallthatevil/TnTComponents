...
public class TnTScheduler_Tests : BunitContext
{
    ...
    #region Schedule View Management Tests
    ...
    public void RemoveScheduleView_RemovesViewFromScheduler()
    {
        ...
        // Assert
        // mockView2 should still be selected since it's still in the scheduler
    ...
    private class MockScheduleView<TEventType> : TnTComponents.Scheduler.Infrastructure.ScheduleViewBase<TEventType>
