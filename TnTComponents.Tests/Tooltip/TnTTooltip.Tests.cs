...
namespace TnTComponents.Tests.Tooltip;
...
public class TnTTooltip_Tests : BunitContext {
    ...
    public TnTTooltip_Tests() {
        ...
        var tooltipModule = JSInterop.SetupModule("./_content/TnTComponents/Tooltip/TnTTooltip.razor.js");
    ...
    public void JsModulePath_ReturnsCorrectPath() {
        ...
        // Assert
        path.Should().Be("./_content/TnTComponents/Tooltip/TnTTooltip.razor.js");
    }
